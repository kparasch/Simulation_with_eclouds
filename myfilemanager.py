...
def monitorh5list_to_dict(filename_list, key='Bunch'):
...
def monitorh5list_to_obj(filename_list, key='Bunch'):
    return  obj_from_dict(monitorh5list_to_dict(filename_list, key))
